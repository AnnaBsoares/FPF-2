...
public class SuplementoController {
    ...
    @PostMapping("/Suplemento")
    public ResponseEntity<Suplemento> Suplemento(@RequestBody Suplemento suplemento) {
    ...
    @PutMapping("/Suplemento/{id}")
    public ResponseEntity<Suplemento> Suplemento(@PathVariable Long id, @RequestBody Suplemento suplemento) {
        Optional<Suplemento> suplementoOptional = suplementoRepository.findById(id);
    ...
    @DeleteMapping("/Suplemento/{id}")
    public ResponseEntity<Void> Suplemento(@PathVariable Long id) {
        Optional<Suplemento> suplementoOptional = suplementoRepository.findById(id);
